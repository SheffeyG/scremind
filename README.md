...
[overlay]
fade_duration = 2.0
hold_duration = [3.0, 5.0]  # [min, max] seconds to hold
fps = 60
...
|---------|--------|-------------|---------|
| `overlay` | `fade_duration` | Fade animation duration in seconds | `2.0` |
| `overlay` | `hold_duration` | Hold time range as `[min, max]` in seconds | `[3.0, 5.0]` |
...
| `interval_reminder` | `bg_color` | Overlay background color as `[r, g, b, a]` array | `[19, 65, 52, 220]` |
| `schedule_reminder` | `time` | Scheduled time in `HH:MM` format | - |
| `schedule_reminder` | `bg_color` | Overlay background color as `[r, g, b, a]` array | `[19, 65, 52, 220]` |
